...
PROCESSED_TNS_STRATIFIED_DATA = PROCESSED_DATA / "density_plots_by_TNS"
PROCESSED_COLOR_STRATIFIED_DATA = PROCESSED_DATA / "density_plots_by_color"
...
# phases used for color analysis
PHASES = (-12, -10, -8, -5)
...
for d in [RAW_DATA, PROCESSED_DATA, PLOTS_DIR, ANALYSIS_RESULTS_DIR, TNS_DENSITY_ANALYSIS_OUTPUT_DIR, FIXED_Z_SNCOSMO_PLOTS, TNS_SEARCH_DATA_DIR, FLUX_PLOTS_DIR,
        ...
        PROCESSED_TNS_STRATIFIED_DATA, PROCESSED_COLOR_STRATIFIED_DATA]:
